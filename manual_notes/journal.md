...
Планируется полностью разобраться в огромном множестве информации, предоставляемой `Nextclade`, реализовать еще больше аналитики в отчетном .md файле, а также реализовать филогенетику подобно той, что представлена в дипломной работе.